...
import ExtraDataDoctor from './ExtraInfor';
...
class DetailsDoctor extends Component {
  ...
  async componentDidMount() {
    let doctor = await getInfoDoctor(this.props.match.params.id);
    this.setState({
  ...
  render() {
    return (
      <>
        ...
        <div className="DetailsDoctor-container">
          <div className="intro-doctor">
            ...
            <div className="content-right">
              ...
              <div className="down">
                {this.state.doctor.MarkDown && this.state.doctor.MarkDown.description && (
          ...
          <div className="schedule">
            ...
            <div className="content-right">
              <ExtraDataDoctor doctorId={this.props.match.params.id} />
            </div>
          </div>
          <div className="details">
            {
              this.state.doctor.MarkDown && this.state.doctor.MarkDown.contentHtml && (
                <div
                  dangerouslySetInnerHTML={{ __html: this.state.doctor.MarkDown.contentHtml }}
                ></div>
              ) //https://stackoverflow.com/questions/37337289/react-js-set-innerhtml-vs-dangerouslysetinnerhtml/64436512#64436512
            }
          </div>
