...
import ExtraDataDoctor from "../Doctor/ExtraInfor";
import { getSpecialtyDetail } from "../../../ApiServices/api";
...
class SpecialtyDetails extends Component {
  ...
  async componentDidMount() {
    ...
    let res = await getSpecialtyDetail({
      id: id,
      location: "ALL",
    });
    console.log(res);
    this.setState({
      dataDetailSpecialty: res.data.data.data,
      arrDoctor: res.data.data.doctorSpecialty,
    });
  }
  ...
  // };
  render() {
    let { dataDetailSpecialty, arrDoctor } = this.state;
    return (
      <>
                  ...
                  <>
                    <div className="each-doctor">
                      <div className="dt-content-left">
                        ...
                        <br></br>
                        <div className="Seemore"><Link to={`/details-doctor/${item.doctorId}`}>See More...</Link></div>
                      </div>
                      ...
                      <div className="dt-content-right">
                        ...
                        <div className="doctor-extra">
                          ...
                          <ExtraDataDoctor doctorId={item.doctorId} />
                        </div>
                      </div>
                    </div>
                  </>
